...
pnpm start`}</CodeBlock>
            ...
            <P>
              ...
              credentials from your local configuration and executes the corresponding on-chain actions.
            </P>
            <Callout icon={Shield}>
              Make sure your{" "}
              <code className="font-mono text-xs text-primary">.env</code>{" "}
              file is configured with the correct encrypted keys before running any automation script.
            </Callout>

            <H3>Auto Claim &amp; Battle</H3>
            <P>Attacks targets and claims stash rewards for every configured account in one run.</P>
            ...
            <P>
              ...
              ,{" "}
              <code className="font-mono text-xs bg-muted px-1.5 py-0.5 rounded text-primary">HBD</code>
              ) and any Hive Engine token (e.g.{" "}
              <code className="font-mono text-xs bg-muted px-1.5 py-0.5 rounded text-primary">SCRAP</code>
              ) — just set the symbol in your configuration.
            </P>
